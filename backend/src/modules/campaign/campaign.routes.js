...
router.post('/', rbacMiddleware(ROLES.ADMIN, ROLES.SUPER_ADMIN), campaignController.createCampaign);
...
router.get('/:id', rbacMiddleware(ROLES.ADMIN, ROLES.SUPER_ADMIN, ROLES.FACULTY), campaignController.getCampaignById);
router.patch('/:id/status', rbacMiddleware(ROLES.ADMIN, ROLES.SUPER_ADMIN), campaignController.changeCampaignStatus);
